...
function RachaelImage() {
  return (
    <StaticImage
      src="https://ebpt.s3-us-west-1.amazonaws.com/images/rachael.jpg"
      alt="Rachael"
    />
  );
}
    ...
    <>
      ...
      <main>
        ...
        <article id="rachael" className="measured">
          ...
          <p className="justified-40">
            Rachael has been living in South Lake Tahoe for over a decade since
            graduating college from UC Berkeley. She worked at Heavenly for
            several seasons as a ski instructor and spends winter on the slopes
            skiing and snowboarding. In the summer, her favorite activities
            include hiking, camping, trail running, and swimming in the lake.
            She loves comedies, traveling, and cooking, and especially her
            feline companion, Kitten Doodle Chicken Noodle. Rachael enjoys her
            job at EBPT but is also looking forward to starting nursing school
            soon.
          </p>
        </article>
      </main>
