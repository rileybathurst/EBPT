    ...
    <>
      ...
      <main>
        ...
        <section id="pt" className="measured">
          ...
          <p>
            This service is a form of rehabilitation for those who have medical
            problems or other health-related conditions that may limit their
            ability to move and function in their daily lives. The goal is to
            help improve mobility and flexibility, reduce pain, restore
            function, and improve quality of life. With a thorough assessment by
            a Physical Therapist your treatment plan will be designed to prevent
            disability or treat ailments that prohibit functionality in everyday
            life.
          </p>

          <p>
            Your program will typically include hands-on manual therapy,
            exercise, and modalities. Exercises can include stretching,
            strengthening, core stabilization, and postural re-education. Your
          ...
          <p>
            A <b>Physical Therapist Assistant</b> (PTA) is licensed and provides
            physical therapy care under the supervision of a Physical Therapist.
          </p>

          <p>
            A <b>Physical Therapy Tech</b> or <b>Aide</b> is an unlicensed
            person who assists a Physical Therapist and is under the direct and
            immediate supervision of a Physical Therapist. The Physical Therapy
            Tech (or Aide) can only provide direct care to the patient if the
        ...
        <section id="aquatic" className="measured">
          ...
          <p>
            We have a wonderful indoor therapy pool with a large 4000-gallon
            capacity. The depth of the pool ranges from 3-5 feet to accommodate
            all heights. Having the therapy pool inside our facility allows us
            to easily incorporate aquatic exercise into your therapy program.
            For advanced clients the pool is large enough to comfortably allow
            swimming against the endless current.
          </p>

          <ul>
            <li>91 degree water relieves pain and stiffness</li>
            <li>
              Buoyancy alleviates pressure from injured joints allowing
              pain-free exercise
            </li>
            <li>
          ...
          <p>
            Aquatic Physical Therapy is the scientific practice of physical
            therapy in an aquatic environment by physical therapists and
            physical therapists assistants. Aquatic Physical Therapy includes
            but is not limited to treatment, rehabilitation, prevention, health,
            wellness and fitness of patient/client populations in an aquatic
            environment. The unique properties of the aquatic environment
            enhance treatments for patients/clients across the age span with
            musculoskeletal, neuromuscular, cardiovascular/pulmonary, and
            integumentary (skin) diseases, disorders, or conditions.
          </p>

          <h3>Things to Know About Our Pool</h3>
          <ul>
            <li>
              Please bring your own bathing suit and towel (should you forget
              your towel, we have a couple extra, just ask).
            </li>
            ...
            <li>
              When walking to the changing room, please walk around on the
              window side of the pool to avoid an accidental fall into the pool.
            </li>
            ...
            <li>
              Please limit your time in the changing room to 10 minutes. We
              often have other patients who need to use the room as well. Should
              you need more than 10 minutes, please let us know – we can
              accommodate by having you come a little earlier or scheduling you
              at a less busy time.
            </li>
          </ul>
        </section>
        ...
        <section id="water" className="measured">
          ...
          <p>
            Water based exercise programs are an excellent way to build
            strength, improve flexibility, enhance cardiovascular health, and
            increase core stability. Buoyancy reduces pressure and strain on
            joints by supporting a significant portion of the body weight. The
            pressure from the water helps to improve circulation. Water provides
            12 times the resistance of air, allowing simple movements to become
            strength training exercises!
          </p>

          <p>
            Warm water loosens stiff joints, helps sore muscles relax, and
            relieves pain. Our pool is heated to 90 degrees, allowing exercise
            at a very comfortable temperature.
          </p>

          <p>
            Pool exercise programs are offered in our indoor pool for a maximum
            of 3 adults in each session. The therapy pool has a 4000-gallon
            capacity, ranges in depth from 3-5 feet, and is equipped with jets
